  ...
  return (
    <div className="max-w-[1400px] mx-auto p-6 lg:p-12 pb-24">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mt-4 gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button 
                onClick={handleSpeak}
                className="p-2 rounded-full bg-night-panel border border-night-border hover:text-primary hover:border-primary/50 transition-colors flex items-center justify-center active:scale-95"
              >
      ...
      <section className="flex flex-col gap-6 mb-10">
        <div className={`${mainCardClass} rounded-3xl p-8 md:p-10 relative overflow-hidden transition-all duration-300 min-h-[280px]`}>
          ...
          <div className="relative z-10 flex flex-col max-w-4xl h-full justify-center">
            ...
            {/* Translation (Gray) */}
            <h3 className="text-slate-400 font-bold text-lg mb-6 uppercase tracking-wide opacity-80">
                {data.translation}
            </h3>
            {/* Definition (White) */}
            <p className="text-slate-100 text-2xl md:text-3xl font-display font-semibold leading-tight">
              {data.definition}
            </p>
          </div>
        </div>
             ...
             {data.practicalUsage ? (
                <div className="p-8 flex flex-col h-full justify-center relative z-10">
                    ...
                    <div className="flex gap-4">
                         ...
                         <p className={`font-display text-lg md:text-xl italic leading-relaxed ${isLight ? 'text-slate-700' : 'text-slate-200'}`}>
